...
class DwConfigs {
  DwConfigs({
    ...
    this.dbConfig = dbConfig ?? DwDBConfig();
    this.languages = languages ?? DwDBConfig.defaultLanguages.keys.toList();
  }
  ...
  final String mailDefault = "example@uproid.com";
  final String mailHost = "smtp.zoho.eu";
  final String widgetsType;
  ...
  final String cookiePassword = 'cookiePassword';

  late final DwDBConfig dbConfig;
