...
import 'package:dartweb/src/widgets/wd_string_widget.dart';

class ErrorWidget implements DwStringWidget {
  static final _vs = DwServer.config.variableStart;
  static final _ve = DwServer.config.variableEnd;
  static final _bs = DwServer.config.blockStart;
  static final _be = DwServer.config.blockEnd;
